...
public class NetworkMagnetUpgrade extends UpgradeItemBase<NetworkMagnetUpgradeWrapper> implements ISUAItemConfig {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level worldIn, @NotNull List<Component> tooltip, @NotNull TooltipFlag flagIn) {
        ...
        if (tag == null) {
            tooltip.add(Component.translatable("item.soph_upgrade_addons.network_magnet_upgrade.tooltip.unlinked").withStyle(ChatFormatting.DARK_AQUA));
            return;
        }
        ...
        tooltip.add(Component.translatable("item.soph_upgrade_addons.network_magnet_upgrade.tooltip.linked.rs")
