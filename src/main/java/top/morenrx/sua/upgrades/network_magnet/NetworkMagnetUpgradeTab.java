...
public class NetworkMagnetUpgradeTab extends UpgradeSettingsTab<NetworkMagnetUpgradeContainer> {
    ...
    protected NetworkMagnetUpgradeTab(NetworkMagnetUpgradeContainer upgradeContainer, Position position, StorageScreenBase<?> screen, Component tabLabel, Component closedTooltip) {
        ...
        if (NETWORK_TYPE_BUTTON_STATES.size() > 1)
            addHideableChild(new ToggleButton<>(new Position(x + 57, y + 24), NETWORK_TYPE,
    ...
    public static class Basic extends NetworkMagnetUpgradeTab {
        public Basic(NetworkMagnetUpgradeContainer upgradeContainer, Position position, StorageScreenBase<?> screen, int slotsPerRow, ButtonDefinition.Toggle<ContentsFilterType> contentsFilterButton) {
            super(upgradeContainer, position, screen, SBPTranslationHelper.INSTANCE.translUpgrade("network_magnet"), SBPTranslationHelper.INSTANCE.translUpgradeTooltip("network_magnet"));
