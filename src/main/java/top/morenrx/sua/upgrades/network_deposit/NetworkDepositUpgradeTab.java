...
public class NetworkDepositUpgradeTab extends UpgradeSettingsTab<DepositUpgradeContainer> {
    protected DepositFilterLogicControl filterLogicControl;

    protected NetworkDepositUpgradeTab(DepositUpgradeContainer upgradeContainer, Position position, StorageScreenBase<?> screen, Component tabLabel, Component closedTooltip) {
    ...
    public static class Basic extends DepositUpgradeTab {
        public Basic(DepositUpgradeContainer upgradeContainer, Position position, StorageScreenBase<?> screen) {
            super(upgradeContainer, position, screen, SBPTranslationHelper.INSTANCE.translUpgrade("network_deposit"), SBPTranslationHelper.INSTANCE.translUpgradeTooltip("network_deposit"));
            filterLogicControl = addHideableChild(new DepositFilterLogicControl.Advanced(screen, new Position(x + 3, y + 24), getContainer().getFilterLogicContainer(),
                    SUAConfig.INSTANCE.networkDepositUpgrade.slotsInRow.get()));
        }
    }
}