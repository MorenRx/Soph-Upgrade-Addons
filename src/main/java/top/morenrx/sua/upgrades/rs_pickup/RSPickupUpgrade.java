...
public class RSPickupUpgrade extends UpgradeItemBase<RSPickupUpgradeWrapper> implements ISUAItemConfig {
    ...
    public RSPickupUpgrade(BooleanSupplier enable, IntSupplier filterSlots) {
