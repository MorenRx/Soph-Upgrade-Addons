...
public class RSDepositUpgrade extends DepositUpgradeItem implements ISUAItemConfig {
    ...
    public RSDepositUpgrade(BooleanSupplier enable, IntSupplier filterSlots) {
        super(filterSlots);
        this.enable = enable;
    }
