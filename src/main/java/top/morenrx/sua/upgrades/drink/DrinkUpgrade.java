...
public class DrinkUpgrade extends UpgradeItemBase<DrinkUpgradeWrapper> implements ISUAItemConfig {
    ...
    public static class Data {
        public static final String DATA_THIRST_LEVEL = "thirstLevel";
        public static final String DATA_DRINK_FOR_HURT = "drinkForHurt";
        public static final String DATA_PURITY = "purity";
