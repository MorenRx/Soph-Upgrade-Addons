...
public class RSPickupUpgrade extends UpgradeItemBase<RSPickupUpgradeWrapper> implements ISBUAItemConfig {
    public static final UpgradeType<RSPickupUpgradeWrapper> TYPE = new UpgradeType<>(RSPickupUpgradeWrapper::new);

    private final IntSupplier filterSlotCount;

    public RSPickupUpgrade() {
        super(Config.SERVER.maxUpgradesPerStorage);
        this.filterSlotCount = SBUAConfig.INSTANCE.rsPickupUpgrade.filterSlots::get;
    }

    @Override
    public boolean isEnable() {
        return SBUACompat.REFINED_STORAGE && SBUAConfig.INSTANCE.rsPickupUpgrade.enable.get();
    }
    ...
    @Override
    public @NotNull UpgradeType<RSPickupUpgradeWrapper> getType() {
        return TYPE;
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level worldIn, @NotNull List<Component> tooltip, @NotNull TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("item.soph_upgrade_addons.rs_pickup_upgrade.tooltip.linked")
